...
class RestApi
{
     ...
     *
     * @return \TwitterPhp\Connection\Profile
     * @throws TwitterRestApiException
     */
    public function connectAsUser()
    {
        ...
        return new Profile($this->_consumerKey,$this->_consumerSecret,$this->_accessToken,$this->_accessTokenSecret);
    }
